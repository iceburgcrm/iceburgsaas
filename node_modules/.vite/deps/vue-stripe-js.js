...
var createElements = (instance, options) => {
  try {
    if (!instance) {
...
var createElement = (elements, elementType, options) => {
  try {
    if (!elements) {
...
var _hoisted_1$1 = { ref: "mountPoint" };
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$1, null, 512);
}
var StripeElement = _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
...
var StripeElements = _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  StripeElement,
  StripeElements,
  createElement,
...
//# sourceMappingURL=vue-stripe-js.js.map
