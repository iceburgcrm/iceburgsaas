...
class CrmCreator
{
    ...
    public function insertDataFromRemoteDatabase($data, $parserData)
    {

    }

    public function getRemoteDatabase3($data = null)
    {
        $name = 'iceburg';
        ...
        Config::set('database.connections.mysql2.collation', $data['collation']);
        Config::set('database.connections.mysql2.charset', $data['character_set']);
        Config::set('database.connections.mysql2.username', $data['username']);
        Config::set('database.connections.mysql2.password', $data['password']);
        ...
        Config::set('database.connections.mysql2.username', env('DB_USERNAME'));
    ...
    public function processSQL($parserTables, $schemaName, $seedAmount = 5, $generateTable = 1, $data = [])
    {
    ...
    public function updateSettingData($name, $data)
    {
        Config::set('database.connections.mysql2.database', $name);
        DB::reconnect();
        ...
        Setting::where('name', 'like', 'description')
            ->update(['value' => $data['description']]);

        Setting::where('name', 'like', 'theme')
    ...
    private function getTableNames($name = 'iceburg')
    {
        ...
        DB::reconnect();
     //   dd(Config::get('database.connections.mysql2.database'));
